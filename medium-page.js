...
document.addEventListener('DOMContentLoaded', () => {
  ...
  var boxes = document.querySelectorAll('.box-1-medium');
  const timerElement = document.querySelector('#timer-medium');
  const scoreElement = document.querySelector('#score-medium');
  ...
  let timeRemaining = 80; // Set the time limit for the game (in seconds)
  ...
  function gameCompleted() {
    ...
    window.location.href = './medium-game-over.html';
  }

window.onload = function () {
  var boxesContainer = document.querySelector(".boxes-medium");
...
function randomizeBoxes(container) {
  var boxes = container.querySelectorAll(".box-1-medium");
  ...
  function startGame() {
    gameStarted = true;
    timeRemaining = 80; // Reset the time when starting the game
